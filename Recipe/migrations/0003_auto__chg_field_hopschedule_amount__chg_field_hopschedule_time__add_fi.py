...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fermentable.description'
        db.add_column('Recipe_fermentable', 'description',
        ...
        db.alter_column('Recipe_yeast', 'attenuation', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Fermentable.description'
        db.delete_column('Recipe_fermentable', 'description')
    ...
    models = {
        ...
        'Recipe.yeast': {
            ...
            'attenuation': ('django.db.models.fields.IntegerField', [], {}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
